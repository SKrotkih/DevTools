...
@interface RTBHTTPServer : NSObject <NSNetServiceDelegate>  // IMPLEMENTED_PROTOCOLS
{
 ...
 * 
 * The default value is [RTBHTTPConnection class].
 * You can override RTBHTTPConnection, and then set this to [MyRTBHTTPConnection class].
 * 
