 ...
 * 
 * RTBHTTPConnection will invoke our readDataOfLength: method to fetch data.
...
- (id)initWithFilePath:(NSString *)fpath forConnection:(RTBHTTPConnection *)parent
{
	if ((self = [super init]))
	{
		HTTPLogTrace();
...
- (NSData *)readDataOfLength:(NSUInteger)length
{
	...
	else
	{
		...
		dispatch_sync(readQueue, ^{
			...
			NSAssert(readSourceSuspended, @"Invalid logic - perhaps RTBHTTPConnection has changed.");
