...
@interface FrameworksTableViewController()
                ...
                bundle: (NSBundle*) nibBundleOrNil
{
    ...
    {
        self.title = NSLocalizedString(@"Frameworks", @"Tab bar item title");
        self.tabBarItem.image = [UIImage imageNamed: [NSString stringWithFormat: @"%@tab_framework", gDevToolsClientResBundlePath]];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	if(cell == nil) 
    {
        ...
        cell = (FrameworkCell *)[[gDevToolsClientResBundle loadNibNamed: @"FrameworkCell"
                                                                  owner: self
...
- (void)tableView: (UITableView *)tableView didSelectRowAtIndexPath: (NSIndexPath *)indexPath 
{
	...
	ListTableViewController *listTVC = [[ListTableViewController alloc] initWithNibName: @"ListTableViewController" 
